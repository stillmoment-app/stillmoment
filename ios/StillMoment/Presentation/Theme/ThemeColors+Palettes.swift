...
extension ThemeColors {
    ...
    static let forestLight = ThemeColors(
        ...
        controlTrack: Color(red: 0.478, green: 0.475, blue: 0.424),
    ...
    static let forestDark = ThemeColors(
        ...
        controlTrack: Color(red: 0.400, green: 0.443, blue: 0.412),
...
extension ThemeColors {
    ...
    static let moonLight = ThemeColors(
        ...
        controlTrack: Color(red: 0.408, green: 0.475, blue: 0.545),
    ...
    static let moonDark = ThemeColors(
        ...
        controlTrack: Color(red: 0.400, green: 0.427, blue: 0.494),
        ...
        cardBorder: Color(red: 0.233, green: 0.237, blue: 0.257),
