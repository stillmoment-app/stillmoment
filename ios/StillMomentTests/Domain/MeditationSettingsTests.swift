...
final class MeditationSettingsTests: XCTestCase {
    ...
    func testValidatePreparationTime_validValues_returnsUnchanged() {
        ...
        XCTAssertEqual(MeditationSettings.validatePreparationTime(25), 25)
        XCTAssertEqual(MeditationSettings.validatePreparationTime(45), 45)
        XCTAssertEqual(MeditationSettings.validatePreparationTime(60), 60)
    }
    ...
    func testValidatePreparationTime_invalidValue_returnsClosest() {
        ...
        XCTAssertEqual(MeditationSettings.validatePreparationTime(23), 25) // Closer to 25 than 20
        XCTAssertEqual(MeditationSettings.validatePreparationTime(32), 30) // Closer to 30 than 35
        XCTAssertEqual(MeditationSettings.validatePreparationTime(58), 60) // Closer to 60 than 55
    }
    ...
    func testValidatePreparationTime_extremeValues_returnsClosestBoundary() {
        ...
        XCTAssertEqual(MeditationSettings.validatePreparationTime(61), 60)
        XCTAssertEqual(MeditationSettings.validatePreparationTime(100), 60)
        XCTAssertEqual(MeditationSettings.validatePreparationTime(1000), 60)
    }
