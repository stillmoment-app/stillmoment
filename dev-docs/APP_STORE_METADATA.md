...
**Maximum:** 100 characters (including commas and spaces)
**Recommended Strategy:** Focus on specific, relevant terms. Avoid duplicating words from app name/subtitle.
...
**Content Descriptors:**
- None (app contains no violence, profanity, mature themes, etc.)
...
**Important:** Select "No, this app does not collect data" for all categories.
...
**Privacy Policy URL:**
```
https://stillmoment-app.github.io/stillmoment/privacy.html
```
...
**Support URL:**
```
https://stillmoment-app.github.io/stillmoment/support.html
```

**Marketing URL (optional):**
```
https://stillmoment-app.github.io/stillmoment/
```

**Support Email:**
```
stillMoment@posteo.de
```
...
**Required Sizes:**
- iPhone 6.7" (iPhone 15 Pro Max, etc.) - 1290 x 2796 pixels
...
- [ ] App description (English + German)
...
### App Review Notes
- [ ] Background audio explanation included
...
1. **Be transparent about background audio**: Explain it clearly in App Review Notes
2. **Emphasize privacy**: Apple loves privacy-first apps
3. **Test on physical device**: Verify background audio works with screen locked
4. **Respond quickly**: If reviewer has questions, respond within 24 hours
5. **Be patient**: First-time approval typically takes 24-48 hours
...
- Plan v1.1 with user-requested improvements
...
For questions or issues, contact: stillMoment@posteo.de
