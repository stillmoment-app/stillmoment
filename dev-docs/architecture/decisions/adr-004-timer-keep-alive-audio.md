...
Keep-Alive und Background-Audio laufen **parallel** (nicht sequenziell). Die lautlose Datei bei Volume 0.05 stoert kein anderes Audio. Gong und Introduction spielen ebenfalls parallel.
