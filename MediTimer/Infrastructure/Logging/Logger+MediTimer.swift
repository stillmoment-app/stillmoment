...
/// Centralized logging system for MediTimer using OSLog
...
extension Logger {
    ...
    /// Subsystem identifier for all MediTimer logs
    private static let subsystem = Bundle.main.bundleIdentifier ?? "com.meditimer"
}
