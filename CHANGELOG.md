...
### Changed (iOS)
- **Running-Timer mit Sanduhr-Vessel statt Atemkreis** - Die Hauptphase der stillen Meditation hat ein neues Visual: eine vertikale Glas-Capsule, deren Fluessigkeitspegel linear ueber die Sitzungsdauer sinkt (warmer Honig-Kupfer-Verlauf, Meniskus-Glanz auf der Wasserlinie, schmaler Glas-Reflex links). Rechts daneben steht die Restzeit prominent in MM:SS-Form (64 pt, monospaced) mit einem Eyebrow "VERBLEIBEND" darueber und einem kursiven "von X Minuten" darunter. Der Pegel-Farbverlauf ist an der Glas-Geometrie verortet, nicht an der Fluessigkeit — die helle Zone bleibt geometrisch oben, die Oberkante schiebt sich durch den Farbverlauf hindurch. Die Pegel-Farben sind bewusst themeunabhaengig (Material-Identitaet "warmer Honig"); Hintergrund- und Textfarben folgen weiter dem aktiven Theme (Kerzenschein/Wald/Mondlicht × Light/Dark). Bei aktivem "Bewegung reduzieren" snappt der Pegel im Sekundentakt an die korrekte Hoehe statt kontinuierlich zu sinken. Der bisherige Atemkreis bleibt fuer den Pre-Roll-Countdown und den Guided-Meditation-Player erhalten — er wird nur in der Hauptphase nicht mehr eingeblendet. Begruendung: eine Meditations-App soll nicht durch eine pulsierende Animation vorgeben, wann ein- und ausgeatmet wird; "Zeit, die rinnt" als raeumlicher Verlauf ist die staerkere Metapher fuer eine stille Sitzung. (Ticket: ios-046)
